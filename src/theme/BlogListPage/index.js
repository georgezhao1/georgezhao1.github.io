        ...
        <animated.div className="hero">
          <div className="bloghome__intro">
            <animated.h1 style={animatedTexts[0]}>
              Hello! I am <span className="intro__name">Dr. George Zhao</span>
            </animated.h1>
            <animated.p style={animatedTexts[1]}>
            Experienced Full-Stack Data Scientist with a Master in Computer Science and a Ph.D. in Engineering; 7+ years of industrial experience in data analytics/machine learning, and web app dev-op fields in top Fortune 500 companies. 10-year programming experience in Python/JS/HTML/CSS, proficient with R/JMP/C++/Java/Matlab/Julia.
            </animated.p>
...
function SocialLinks({ animatedProps, ...props }) {
  ...
  return (
    <animated.div className="social__links" style={animatedProps}>
      <a href="https://www.linkedin.com/in/zhun-zhao/">
        <FontAwesomeIcon icon={faLinkedin} size="lg" />
      </a>
      <a href="https://github.com/georgezhao1">
